...
- [x] Open-source prep (D-044) — MIT LICENSE with a data-terms note, contact address moved to
      adsb@voygent.ai, full README with FOUR real screenshots of live traffic, single-user-by-design
      stated up front. Screenshots generated by scripts/shoot_readme.py, which refuses to write
      anything if the feed is empty.
